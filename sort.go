...
func main() {
	...
	fmt.Println("rverse sorted p3 : ",p3)
	sort.Strings(p3)
	fmt.Println("Sorted p3        : ",p3)
	...
	fmt.Println("sorted p4        : ",p4)
	fmt.Println("sorted p1        : ",p1)  //custom

	sort.Sort(p2)
	fmt.Println("sorted p2        : ",p2)  // custom
...
func(a inte) Less(i,j int) bool{            //sort in reverse order
	return a[i]>a[j]
}
